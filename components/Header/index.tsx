          ...
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-50 max-w-full px-5 xl:mr-12">
              <Link href="/" className={`header-logo block w-full ${sticky ? "py-5 lg:py-2" : "py-8"} `}>
                <Image src="/images/logo/indomie.webp" alt="indomie" width={120} height={80} className="dark:hidden" />
                <Image src="/images/logo/indomie.webp" alt="indomie" width={120} height={80} className="hidden dark:block" />
              </Link>
            </div>
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                >
                  <ul className="block lg:ml-auto lg:flex lg:space-x-12">
                          ...
                          <>
                            ...
                            >
                              {menuItem.submenu.map((submenuItem) => (
                                <Link href={submenuItem.path} key={submenuItem.id} className="block rounded py-2.5 pl-4 text-sm text-dark hover:opacity-70 dark:text-white lg:px-3 lg:pl-0">
                                  {submenuItem.title}
                                </Link>
                              ))}
                            </div>
